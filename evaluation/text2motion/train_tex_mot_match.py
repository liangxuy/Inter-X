...
from data.dataset import Text2MotionDatasetV2HHI, collate_fn
...
if __name__ == '__main__':
    ...
    train_dataset = Text2MotionDatasetV2HHI(opt, train_split_file, w_vectorizer, train_motion_file)
    val_dataset = Text2MotionDatasetV2HHI(opt, val_split_file, w_vectorizer, val_motion_file)

    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, drop_last=True, num_workers=8,
                              shuffle=True, collate_fn=collate_fn, pin_memory=True) # 4
